      ...
      >
        ...
        >
          <Heading
            ...
            lineHeight={{base:"130%", sm: '110%', md: '120%', xl: '140%', '2xl': '130%' }}
            color="#434343"
            fontWeight="400"
        ...
        <Flex w={{base:"100%", sm: '38.4%' }} mt={{base:"20px", sm:"0px"}} gap="5px" animation="bounceFromBottom 0.3s">
          <VStack mt={{base:"60px", sm: '45px', md: '60px', lg: '71px', xl: '99px' }}>
            <Image
